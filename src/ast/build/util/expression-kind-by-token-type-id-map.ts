...
export const expressionKindByTokenTypeId: Map<number, ExpressionKind> = new Map();
...
Object.values(TokenTypeId).forEach((tokenTypeId) => {
  switch (tokenTypeId) {
    ...
    case TokenTypeId.BinaryExpression:
      expressionKindByTokenTypeId.set(tokenTypeId, ExpressionKind.BINARY);
      break;
    case TokenTypeId.UnaryExpression:
      expressionKindByTokenTypeId.set(tokenTypeId, ExpressionKind.UNARY);
      break;
    case TokenTypeId.LengthofExpression:
      expressionKindByTokenTypeId.set(tokenTypeId, ExpressionKind.LENGTHOF);
      break;
