...
export const arrayDimensionKindByTokenTypeId: Map<number, ArrayDimensionKind> = new Map();
...
Object.values(TokenTypeId).forEach((tokenTypeId) => {
  switch (tokenTypeId) {
    case TokenTypeId.ExplicitArrayDimension:
      arrayDimensionKindByTokenTypeId.set(tokenTypeId, ArrayDimensionKind.EXPLICIT);
      break;
    case TokenTypeId.ImplicitArrayDimension:
      arrayDimensionKindByTokenTypeId.set(tokenTypeId, ArrayDimensionKind.IMPLICIT);
      break;
    case TokenTypeId.PartialArrayDimension:
      arrayDimensionKindByTokenTypeId.set(tokenTypeId, ArrayDimensionKind.PARTIAL);
      break;
