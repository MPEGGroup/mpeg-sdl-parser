...
export const stringLiteralKindByTokenTypeId: Map<number, StringLiteralKind> = new Map();
...
Object.values(TokenTypeId).forEach((tokenTypeId) => {
  switch (tokenTypeId) {
    case TokenTypeId.Base64StringLiteral:
      stringLiteralKindByTokenTypeId.set(tokenTypeId, StringLiteralKind.BASIC);
      break;
    case TokenTypeId.UtfStringLiteral:
      stringLiteralKindByTokenTypeId.set(tokenTypeId, StringLiteralKind.UTF);
      break;
