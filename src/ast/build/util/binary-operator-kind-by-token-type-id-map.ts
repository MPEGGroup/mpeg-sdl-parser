import type { BinaryOperatorKind } from "../../node/enum/binary-operator-kind.ts";
...
export const binaryOperatorKindByTokenTypeId: Map<number, BinaryOperatorKind> = new Map();
