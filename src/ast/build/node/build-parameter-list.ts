...
export function buildParameterList(buildContext: BuildContext): ParameterList {
  ...
  const { nodes: parameters, commaPunctuators } = fetchOneToManyCommaSeparatedList<Parameter>(
    buildContext,
    NodeKind.PARAMETER,
  );
