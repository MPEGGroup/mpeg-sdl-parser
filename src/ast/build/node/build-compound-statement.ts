...
export function buildCompoundStatement(buildContext: BuildContext): CompoundStatement {
  ...
  return new CompoundStatement(openBracePunctuator, statements, closeBracePunctuator, [
    openBracePunctuator,
    ...statements,
