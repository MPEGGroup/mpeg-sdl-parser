...
export { blockStatementNodeProp } from "./src/lezer/props/block-statement-node-prop-source.ts";
export { primitiveNodeProp } from "./src/lezer/props/primitive-node-prop-source.ts";
export { syntacticTokenNodeProp } from "./src/lezer/props/syntactic-token-node-prop-source.ts";
